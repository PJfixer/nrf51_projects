...
#define APP_ADV_INTERVAL                4000                                          /**< The advertising interval (in units of 0.625 ms; this value corresponds to 40 ms). */
...
static void app_timer_go_sleep_handler(void * p_param)
{
     uint32_t err_code;
    ...
    {
         NRF_LOG_INFO("stop advertising + go dodo \n");
         go_sleep();
    }     
...
static void timers_init(void)
{
    ...
    APP_TIMER_INIT(APP_TIMER_PRESCALER, APP_TIMER_OP_QUEUE_SIZE, false);
       ...
       uint32_t err_code;
       err_code = app_timer_create(&m_repeated_timer_id, APP_TIMER_MODE_REPEATED,app_timer_go_sleep_handler );
       APP_ERROR_CHECK(err_code); 
}
...
static void advertising_init(void)
{
 ...
 //set PJFIXER IDENTIFIER
  ...
  //set device type 0xF2 = pres sensor 
  adata[4] = 0xF2;
...
void gpio_sense_init(void)
{
      // This pin is used for waking up from system off and is active low+-0, so enable sense capabilities
  nrf_gpio_cfg_input(SENSOR_PIN, NRF_GPIO_PIN_NOPULL);
  NRF_GPIO->PIN_CNF[SENSOR_PIN] |= (GPIO_PIN_CNF_SENSE_High << GPIO_PIN_CNF_SENSE_Pos);
}
...
static void application_timers_start(void)
{
       ...
       uint32_t err_code;
       err_code = app_timer_start(m_repeated_timer_id, APP_TIMER_TICKS(30000,APP_TIMER_PRESCALER), NULL);
       APP_ERROR_CHECK(err_code);
